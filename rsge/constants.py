...
ERROR_CODES = {
    ...
    -1035: {'type': 1,
            ...
            'error_msg_ru': u'Во время внутренних перевозок индетификационный код покупателя должен быть заполнен или же нужно указать код продавца'},
    -1036: {'type': 1,
...
WAYBILL_TYPE_PUBLIC_TRANSPORT = 2
WAYBILL_TYPE_RUNNER = 3
...
WAYBILL_TYPES = {
    ...
    WAYBILL_TYPE_PUBLIC_TRANSPORT: u"ტრანსპორტირებით",
    WAYBILL_TYPE_RUNNER: u"ტრანსპორტირების გარეშე",
